...
_class="class-dump-z -pabkkzARH -X NS,C" # you can easily add -S, -s, -a and -A flags ;) 
...
filterName() {
	shopt -s extglob; nameOf="$i"; nameF=${nameOf//@(.framework)/}; echo $nameF;
}
